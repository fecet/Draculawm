...
static const char *const panel[] = {
    "xfce4-panel", "Xfce4-panel"}; /* name & cls of panel win */
...
static const int nmaxmaster =
    2; /* maximum number of clients allowed in master area */
...
static const char *rofiruncmd[] = {"rofi",
                                   "-show",
                                   "drun",
                                   "-modi",
                                   "drun",
                                   ...
                                   TERMRUN "{cmd}",
                                   NULL};
static const char *rofiquitcmd[] = {"rofi",
                                    "-show",
                                    "p",
                                    "-modi",
                                    "p:rofi-power-menu",
                                    "-font",
                                    "NotoSans Nerd Font Regular 16",
                                    "-width",
                                    "20",
                                    "-lines",
                                    "4",
